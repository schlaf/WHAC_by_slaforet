...
public class StartActivity extends ActionBarActivity implements ChangeFactionListener, ChooseArmyListener {
	...
	private static final String NOTIFICATION_DONE_V162 = "v1.6.2";
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		if ( ! notifyNews.contains(NOTIFICATION_DONE_V162)) {
		    ...
		    try {
	            InputStream fin = getAssets().open("version162.html");
			...
			alert.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
				public void onClick(DialogInterface dialog, int whichButton) {
					...
					editor.putBoolean(NOTIFICATION_DONE_V162, true);
					editor.commit();
				}
			});
